...
interface RecurringDepositPageProps {
  locale: 'en' | 'hi';
}

const RecurringDepositPage: React.FC<RecurringDepositPageProps> = ({ locale }) => {
  ...
  React.useEffect(() => {
    trackPageView('Recurring Deposit', locale === 'hi' ? 'आवर्त जमा' : 'Recurring Deposit');
  }, [locale]);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setSubmitted(true);
      trackFormSubmission('recurring-deposit', JSON.stringify(formData));
  ...
  const breadcrumbs = [
    ...
    { label: 'Recurring Deposit', labelHi: 'आवर्त जमा', href: `/${locale}/personal/deposits/recurring-deposit` }
  ];

  const heroData = {
    title: locale === 'hi' ? 'आवर्त जमा योजना' : 'Recurring Deposit Scheme',
    subtitle: locale === 'hi' 
      ? 'विशेष ब्याज दरें पर नियमित आय से अपना धन दोगुना करें'
      : 'Build wealth systematically with our recurring deposit options offering attractive rates',
    ctaText: locale === 'hi' ? 'अभी जमा करें' : 'Apply Now',
    ctaHref: `/${locale}/personal/deposits/recurring-deposit#apply`,
    image: '/images/recurring-deposit-hero.jpg',
    features: [
      {
        icon: '🔄',
        title: locale === 'hi' ? 'व्यवस्थिक बचत बढ़ाएं' : 'Systematic Savings',
        description: locale === 'hi' ? 'नियमित आय से बचत बढ़ाएं' : 'Build wealth through regular deposits'
      },
      {
        icon: '💰',
        title: locale === 'hi' ? 'आकर्षिव ब्याज' : 'Competitive Rates',
        description: locale === 'hi' ? 'वार्षिक ब्याज दरें' : 'Attractive interest rates'
      },
      {
        icon: '🎯',
        title: locale === 'hi' ? 'लचबीत लक्ष्य' : 'Flexible Amounts',
        description: locale === 'hi' ? 'विभिन्न जमा राशि' : 'Choose deposit amounts that suit you'
      }
    ]
  };
        ...
        <div className="space-y-6">
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-6">
            <h3 className="text-lg font-semibold text-blue-900 mb-4">
              {locale === 'hi' ? 'आवर्त जमा योजना के लाभ' : 'Recurring Deposit Benefits'}
            </h3>
            <ul className="space-y-3">
              <li className="flex items-start">
                ...
                <span className="text-gray-700">
                  {locale === 'hi' ? 'व्यवस्थिक बचत बढ़ाएं' : 'Systematic savings habit'}
                </span>
              </li>
              <li className="flex items-start">
                <svg className="w-5 h-5 text-blue-600 mr-3 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <li className="flex items-start">
                ...
                <span className="text-gray-700">
                  {locale === 'hi' ? 'आसान निकासी पहुंच' : 'Easy online management'}
                </span>
              </li>
            </ul>
          </div>
            ...
            <div className="bg-white rounded-lg shadow-card border border-gray-200 p-6">
              ...
              <ul className="space-y-2">
                ...
                <li className="flex items-center">
                  ...
                  <span className="text-gray-700">
                    {locale === 'hi' ? 'लचबीत अवधि' : 'Flexible frequency'}
                  </span>
                </li>
                <li className="flex items-center">
                  <svg className="w-4 h-4 text-bank-blue-600 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="space-y-6">
          <div className="bg-white rounded-lg shadow-card border border-gray-200 p-6">
            <h3 className="text-lg font-semibold text-gray-900 mb-6">
              {locale === 'hi' ? 'आवर्त जमा खोलने के लिए आवेदन करें' : 'Apply for Recurring Deposit'}
            </h3>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                ...
                >
                  <option value="monthly">{locale === 'hi' ? 'मासिक' : 'Monthly'}</option>
                  <option value="quarterly">{locale === 'hi' ? 'त्रैमासिक' : 'Quarterly'}</option>
                  <option value="half-yearly">{locale === 'hi' ? 'अर्ध वार्षिक' : 'Half-Yearly'}</option>
                  <option value="yearly">{locale === 'hi' ? 'वार्षिक' : 'Yearly'}</option>
                </select>
              </div>
  ...
  const relatedProducts = [
    ...
    },
    {
      ...
      name: 'Double Deposit',
      nameHi: 'डबल जमा',
      description: 'Maximize returns with double deposit scheme',
      descriptionHi: 'डबल जमा योजना के साथ अधिक ब्याज',
      image: '/images/double-deposit.jpg',
      interestRate: 7.5,
      ctaText: 'Learn More',
      ctaTextHi: 'अधिक जानें',
      ctaHref: `/${locale}/personal/deposits/double-deposit`,
      badge: {
        text: 'Popular',
        textHi: 'लोकप्रिय',
        color: 'blue'
  ...
  return (
    <ProductPageShell
      locale={locale}
      title={locale === 'hi' ? 'आवर्त जमा योजना' : 'Recurring Deposit Scheme'}
      titleHi={locale === 'hi' ? 'आवर्त जमा योजना' : 'Recurring Deposit Scheme'}
      description={locale === 'hi' 
        ? 'हमारे आवर्त जमा योजनाओं के साथ अपना धन दोगुना और अधिक ब्याज अर्जित करें'
        : 'Build wealth systematically with our recurring deposit options offering competitive interest rates and secure investment options.'
      }
    ...
    >
      ...
      <KFSPanel
        ...
        subtitle={locale === 'hi' 
          ? 'आवर्त जमा खोलने से पहले सभी महत्वपूर्ण जानकारी पढ़ें'
        ...
        downloadUrl="/documents/recurring-deposit-kfs.pdf"
        items={[
          {
            label: 'Interest Rate',
            labelHi: 'ब्याज दर',
