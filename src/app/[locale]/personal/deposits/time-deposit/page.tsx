...
interface TimeDepositPageProps {
  locale: 'en' | 'hi';
}

const TimeDepositPage: React.FC<TimeDepositPageProps> = ({ locale }) => {
  ...
  React.useEffect(() => {
    trackPageView('Time Deposit', locale === 'hi' ? 'समय जमा' : 'Time Deposit');
  }, [locale]);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setSubmitted(true);
      trackFormSubmission('time-deposit', JSON.stringify(formData));
  ...
  const breadcrumbs = [
    ...
    { label: 'Time Deposit', labelHi: 'समय जमा', href: `/${locale}/personal/deposits/time-deposit` }
  ];

  const heroData = {
    title: locale === 'hi' ? 'समय जमा योजना' : 'Time Deposit Scheme',
    subtitle: locale === 'hi' 
      ? 'विशेष ब्याज दरें पर नियमित आय से अपना धन दोगुना करें'
      : 'Earn steady returns with our time deposit schemes offering competitive rates',
    ctaText: locale === 'hi' ? 'अभी जमा करें' : 'Apply Now',
    ctaHref: `/${locale}/personal/deposits/time-deposit#apply`,
    image: '/images/time-deposit-hero.jpg',
    features: [
      {
        icon: '📅',
        title: locale === 'hi' ? 'नियमित आय' : 'Fixed Returns',
        description: locale === 'hi' ? 'गारंटीड रिटर्न' : 'Guaranteed returns on maturity'
      },
      {
        icon: '💰',
        ...
        <div className="space-y-6">
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-6">
            <h3 className="text-lg font-semibold text-blue-900 mb-4">
              {locale === 'hi' ? 'समय जमा योजना के लाभ' : 'Time Deposit Benefits'}
            </h3>
            <ul className="space-y-3">
              <li className="flex items-start">
                ...
                <span className="text-gray-700">
                  {locale === 'hi' ? 'नियमित रिटर्न' : 'Guaranteed returns'}
                </span>
              </li>
              <li className="flex items-start">
                <svg className="w-5 h-5 text-blue-600 mr-3 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <span className="text-gray-700">
                  {locale === 'hi' ? 'सुरक्षित निवेश्ट' : 'Secure investment'}
                </span>
              </li>
              <li className="flex items-start">
                <svg className="w-5 h-5 text-blue-600 mr-3 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="bg-white rounded-lg shadow-card border border-gray-200 p-6">
              ...
              <ul className="space-y-2">
                ...
                <li className="flex items-center">
                  ...
                  <span className="text-gray-700">
                    {locale === 'hi' ? 'लचबीत अवधि' : 'Flexible tenure'}
                  </span>
                </li>
                <li className="flex items-center">
                  <svg className="w-4 h-4 text-bank-blue-600 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="space-y-6">
          <div className="bg-white rounded-lg shadow-card border border-gray-200 p-6">
            <h3 className="text-lg font-semibold text-gray-900 mb-6">
              {locale === 'hi' ? 'समय जमा खोलने के लिए आवेदन करें' : 'Apply for Time Deposit'}
            </h3>
  ...
  return (
    <ProductPageShell
      locale={locale}
      title={locale === 'hi' ? 'समय जमा योजना' : 'Time Deposit Scheme'}
      titleHi={locale === 'hi' ? 'समय जमा योजना' : 'Time Deposit Scheme'}
      description={locale === 'hi' 
        ? 'हमारे समय जमा योजनाओं के साथ अपना धन दोगुना और अधिक ब्याज अर्जित करें'
        : 'Invest in our time deposit schemes offering competitive interest rates and secure investment options.'
      }
    ...
    >
      ...
      <KFSPanel
        ...
        subtitle={locale === 'hi' 
          ? 'समय जमा खोलने से पहले सभी महत्वपूर्ण जानकारी पढ़ें'
        ...
        downloadUrl="/documents/time-deposit-kfs.pdf"
        items={[
          {
            label: 'Interest Rate',
            labelHi: 'ब्याज दर',
