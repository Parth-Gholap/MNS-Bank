...
export async function generateMetadata({ params }: HomePageProps): Promise<Metadata> {
  ...
  return {
    title: locale === 'hi' 
      ? 'महानगर नागरिक सहकारी बैंक - महानगर नागरिक सहकारी बैंक' 
      : 'Mahanager Nagrik Sahakari Bank - Leading Banking Services',
    description: locale === 'hi'
      ? 'महानगर नागरिक सहकारी बैंक में बैंकिंग सेवाएं, ऋण, और निवेशन समाधान प्रदान करता है।'
      : 'Mahanager Nagrik Sahakari Bank offers comprehensive banking services, loans, and digital solutions.',
    keywords: locale === 'hi'
      ? 'बैंक, बैंकिंग, ऋण, डिजिटल बैंकिंग, खाता, क्रेडिट कार्ड'
      : 'bank, banking, loans, digital banking, account, credit card',
    openGraph: {
      title: locale === 'hi' 
        ? 'महानगर नागरिक सहकारी बैंक' 
        : 'Mahanager Nagrik Sahakari Bank',
      description: locale === 'hi'
        ? 'भारत का प्रमुख बैंक - आपकी वित्त वित्त विश्वास के लिए'
        : 'India\'s Premier Bank - Your Trusted Financial Partner',
      images: [
        {
          url: '/images/og-home.jpg',
          width: 1200,
          height: 630,
          alt: locale === 'hi' ? 'महानगर नागरिक सहकारी बैंक होमपेज' : 'Mahanager Nagrik Sahakari Bank Homepage',
        },
      ],
    },
    twitter: {
