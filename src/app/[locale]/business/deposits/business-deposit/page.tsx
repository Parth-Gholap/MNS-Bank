...
interface BusinessDepositPageProps {
  locale: 'en' | 'hi';
}

const BusinessDepositPage: React.FC<BusinessDepositPageProps> = ({ locale }) => {
  ...
  React.useEffect(() => {
    trackPageView('Business Deposit', locale === 'hi' ? 'व्यापार जमा' : 'Business Deposit');
  }, [locale]);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setSubmitted(true);
      trackFormSubmission('business-deposit', JSON.stringify(formData));
  ...
  const breadcrumbs = [
    ...
    { label: 'Deposits', labelHi: 'जमा', href: `/${locale}/business/deposits` },
    { label: 'Business Deposit', labelHi: 'व्यापार जमा', href: `/${locale}/business/deposits/business-deposit` }
  ];

  const heroData = {
    title: locale === 'hi' ? 'व्यापार जमा' : 'Business Deposit',
    subtitle: locale === 'hi' 
    ...
    ctaHref: `/${locale}/business/deposits/business-deposit#apply`,
    image: '/images/business-deposit-hero.jpg',
    features: [
      {
        icon: '💼',
        title: locale === 'hi' ? 'व्यापार-अनुकूल' : 'Business-Focused',
        description: locale === 'hi' ? 'व्यापार जरूरतों के लिए विशेष योजनाएं' : 'Schemes designed for business needs'
      },
      {
        icon: '💰',
        title: locale === 'hi' ? 'आकर्षिव ब्याज' : 'Competitive Rates',
        description: locale === 'hi' ? 'वार्षिक ब्याज दरें' : 'Attractive interest rates for business deposits'
      },
      {
        icon: '🔒',
        title: locale === 'hi' ? 'सुरक्षित निवेश्ट' : 'Secure Investment',
        description: locale === 'hi' ? 'आपका धन पूर्ण सुरक्षा' : 'Your business deposits are fully secured'
      }
    ]
  };
        ...
        <div className="space-y-6">
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-6">
            <h3 className="text-lg font-semibold text-blue-900 mb-4">
              {locale === 'hi' ? 'व्यापार जमा के लाभ' : 'Business Deposit Benefits'}
            </h3>
            <ul className="space-y-3">
              ...
              <li className="flex items-start">
                ...
                <span className="text-gray-700">
                  {locale === 'hi' ? 'लचबील अवधि' : 'Flexible tenure options'}
                </span>
              </li>
              <li className="flex items-start">
                <svg className="w-5 h-5 text-blue-600 mr-3 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-6">
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-start">
                ...
                <span className="text-gray-700">
                  {locale === 'hi' ? 'न्यूनतम वार्षिक कारोबार' : 'Minimum annual turnover: ₹1,00,000'}
                </span>
              </li>
              <li className="flex items-start">
                <svg className="w-5 h-5 text-yellow-600 mr-3 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="space-y-6">
          <div className="bg-white rounded-lg shadow-card border border-gray-200 p-6">
            <h3 className="text-lg font-semibold text-gray-900 mb-6">
              {locale === 'hi' ? 'व्यापार जमा खोलने के लिए आवेदन करें' : 'Apply for Business Deposit'}
            </h3>
  ...
  return (
    <ProductPageShell
      locale={locale}
      title={locale === 'hi' ? 'व्यापार जमा' : 'Business Deposit'}
      titleHi={locale === 'hi' ? 'व्यापार जमा' : 'Business Deposit'}
      description={locale === 'hi' 
        ? 'हमारे व्यापार जमा योजनाओं के साथ अपने धन दोगुना करें'
        : 'Maximize your business returns with our attractive deposit schemes offering competitive rates and secure investment options.'
      }
    ...
    >
      ...
      <KFSPanel
        ...
        subtitle={locale === 'hi' 
          ? 'व्यापार जमा खोलने से पहले सभी महत्वपूर्ण जानकारी पढ़ें'
        ...
        downloadUrl="/documents/business-deposit-kfs.pdf"
        items={[
          {
            label: 'Interest Rate',
            labelHi: 'ब्याज दर',
...
export default BusinessDepositPage;
